...
- When initally setting up a DHIS2 system, we often need to transform and import (meta)data from external data sources.
...
- Bash 
- SQL: May be useful for transforming large datasets or if you know SQL.
...
-  Do not forget about repetability and testability.
...
- Lets be sure that they are acutally there by asking the API for them and testing against out file.
...
- Our file looks like it has some data elemnent groups. 
...
- Post to the metadata API as JSON like the othe metadata
